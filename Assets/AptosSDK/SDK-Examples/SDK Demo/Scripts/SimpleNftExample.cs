...
namespace Aptos.Unity.Sample
{
    public class SimpleNftExample : MonoBehaviour
    {
        ...
        IEnumerator RunSimpleNftExample()
        {
            ...
            #region Character & Token Naming Details
            ...
            Debug.Log("<color=cyan>=== Creating Character and Token ===</color>");
            ...
            Debug.Log("Create Character Response: " + responseInfo.message);
            string transactionHash = createCollectionTxn.Hash;
            Debug.Log("Create Character Hash: " + createCollectionTxn.Hash);
            #endregion
            ...
            Debug.Log("Alice's Character: " + getCollectionResult);
            #endregion
